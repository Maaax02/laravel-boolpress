...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onAttachmentChange: function onAttachmentChange(event) {
      // Leggiamo l'elenco dei file scelti dall'utente tramite l'input
      // event.target.files
  ...
  return _c("div", [
    ...
    !_vm.formSubmitted
      ? _c("div", [
          ...
          _c("div", { staticClass: "mb-3" }, [
            ...
            _vm.formValidationErrors && _vm.formValidationErrors.attachment
              ? _c("span", { staticClass: "text-danger" }, [
                  _vm._v(_vm._s(_vm.formValidationErrors.attachment)),
                ])
              : _vm._e(),
          ]),
          _vm._v(" "),
      ...
      : _c("div", { staticClass: "alert alert-success py-5" }, [
          _c("h1", [_vm._v("La tua richiesta è stata inviata")]),
        ]),
  ])
}
var staticRenderFns = []
